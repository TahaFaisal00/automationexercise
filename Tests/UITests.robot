...
Quantity Accepts Negative Values
    ...
    automationexercise_Res.Set And Verify Quantity To Negative Number
    ...    ${PRODUCT.minus_quantity}
    ...    ${PRODUCT.minus_quantity}
...
Search By Product Name
    ...
    [Tags]    functional    ui    positive
    automationexercise_Res.Search Products And Verify Results
    ...    ${ALL_PRODUCTS}
    ...    ${MEN_TSHIRT}
    ...    ${MEN_TSHIRT}
    ...    ${LACE_TOP_FOR_WOMEN}
    ...    ${FROZEN_TOPS_FOR_KIDS}
    ...    ${BLUE_TOP}

Filter By Category
    [Documentation]    Filters products by category and verifies only the matching products appear.
    [Tags]    functional    ui    positive
    automationexercise_Res.Choose Category And Verify Results
    ...    ${ALL_PRODUCTS}
    ...    ${WOMEN_MENU}
    ...    ${TOPS_CATEGORY}
    ...    ${TOPS_CATEGORY_PAGE}
...
Filter By Brand
    ...
    [Tags]    functional    ui    positive
    automationexercise_Res.Choose Brand Filter And Verify Results
    ...    ${ALL_PRODUCTS}
    ...    ${ALLEN_SOLLY_JUNIOR_BRAND}
    ...    ${ALLEN_SOLLY_JUNIOR_PAGE}
    ...    ${FROZEN_TOPS_FOR_KIDS}
    ...    ${MEN_TSHIRT}
    ...    ${LACE_TOP_FOR_WOMEN}
    ...    ${BLUE_TOP}
