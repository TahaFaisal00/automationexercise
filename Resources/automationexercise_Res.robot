...
Generate New Account Data
    ...
    VAR    &{TEST_ACCOUNT}=
    ...    user_name=${fake_register_user_name}
    ...    email=${fake_register_email}
    ...    password=${fake_register_password}
    ...    first_name=${SIGNUP_DETAILS.first_name}
    ...    last_name=${SIGNUP_DETAILS.last_name}
    ...    title=${SIGNUP_DETAILS.title}
    ...    company=${SIGNUP_DETAILS.company}
    ...    address1=${SIGNUP_DETAILS.address1}
    ...    address2=${SIGNUP_DETAILS.address2}
    ...    country=${SIGNUP_DETAILS.country}
    ...    state=${SIGNUP_DETAILS.state}
    ...    city=${SIGNUP_DETAILS.city}
    ...    zipcode=${SIGNUP_DETAILS.zipcode}
